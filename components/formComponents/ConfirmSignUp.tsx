...
interface ConfirmSignUpProps {
  confirmSignUp: (data: FormData) => void;
}

function ConfirmSignUp({ confirmSignUp }: ConfirmSignUpProps) {
        ...
        <div className="w-full max-w-144">
          <form className="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4">
            ...
            <div className="mb-6">
              ...
              <input
              onChange={onChange} name="authcode"
            ...
            <div className="flex items-center justify-between">
              <button onClick={() => confirmSignUp(formData)} className="bg-primary hover:bg-primary text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline" type="button">
                Confirm Sign Up
              </button>
